...
#==============================================================================
                ...
                self.num_partitions = dis.indexing_allocate(term, self.all_sockets, self.lines) # read text 
...
#==============================================================================
                ...
                if self.partitions_received == self.num_partitions: # collecting finished
                    ...
                    dis.search_result_return(self.record_from_sock, self.list_search_idx, self.lines)
